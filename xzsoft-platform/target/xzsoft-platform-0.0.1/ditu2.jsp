...
<html>
  <head>
	...
	function staticsUserAddress(){
		...
		/*  var  userData ="{'strongList':[{name:'昌吉', geoCoord:[87.296038,44.007058]},{name:'石河子', geoCoord:[85.614899,42.127001]},{name:'库尔勒', geoCoord:[86.06,41.68]},{name:'库车', geoCoord:[83.459807,41.781933]},{name:'呼图壁', geoCoord:[86.693166,44.380956]},{name:'五家渠', geoCoord:[87.565449,44.368899]},{name:'巴里坤', geoCoord:[85.614899,42.127001]},{name:'库车', geoCoord:[83.45, 41.78]},{name:'阜康', geoCoord:[88.30, 44.42]},{name:'青河', geoCoord:[90.37, 46.71]},{name:'阿勒泰', geoCoord:[85.13, 46.78]},{name:'哈巴河', geoCoord:[86.41, 48.05]},{name:'新源', geoCoord:[83.27, 43.41]},{name:'鄯善', geoCoord:[90.25	,42.82]},{name:'哈密', geoCoord:[93.44	,42.78]},{name:'', geoCoord:[43.92,115.05]},{name:'', geoCoord:[41.78,85.61]},{name:'', geoCoord:[26.59,83.45]},{name:'', geoCoord:[24.02,101.73]},{name:'', geoCoord:[22.643974,110.151676]},{name:'', geoCoord:[21.61,83.45]},{name:'', geoCoord:[89.19,42.91]},{name:'', geoCoord:[93.44	,42.78]},{name:'', geoCoord:[86.06,41.68]},{'name':'','geoCoord':['89.18298','43.975478']},{'name':'','geoCoord':['87.56498774','43.84038035']}],'weakList':[{name:'鄂托克旗', geoCoord:[107.75202, 39.286297]},{name:'玉林', geoCoord:[110.151676, 22.643974]},{name:'贵阳', geoCoord:[106.709177, 26.629907]},{name:'喀什', geoCoord:[75.99,39.47]},{name:'吐鲁番', geoCoord:[89.19,42.91]},{name:'哈密', geoCoord:[93.44	,42.78]},{'name':'','geoCoord':['89.18298','43.975478']},{'name':'','geoCoord':['87.56498774','43.84038035']}],'inList':[{name:'喀什', geoCoord:[79.93,37.11]},{name:'喀什', geoCoord:[75.99,39.47]},{name:'', geoCoord:[89.19,42.91]},{name:'哈密', geoCoord:[93.44	,42.78]},{name:'叶城', geoCoord:[77.223631,36.993014]},{'name':'','geoCoord':['89.18298','43.975478']},{name:'泽普', geoCoord:[77.226408,38.122553]},{'name':'乌鲁木齐市','geoCoord':['87.56498774','43.84038035']}],'currentMonth':'2017年-11月'}";
