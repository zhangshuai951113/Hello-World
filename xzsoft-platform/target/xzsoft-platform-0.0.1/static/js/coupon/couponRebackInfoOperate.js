...
function openCouponRebackInfo(number){
	$("#couponRebackTableList").html("");
	var couponInfoId = $("#couponInfoId").val();
	$.ajax({
		url:"getCouponRebackInfoByCouponInfoId",
		...
		success:function(responseText){
			...
			$.each(objs,function(index,ele){
				...
				//将tr追加到
				$("#couponRebackTableList").append(tr);
			});
		}
	});
