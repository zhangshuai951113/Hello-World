...
;(function ($,window,document,undefined) {
    ...
    SliderUnlock.prototype.move = function () {
        ...
        if (me.index+me.labelWidth+2 == me.max && me.max > 0 && me.isOk) {
            ...
            var basePath = locations[0]+'//'+locations[2]+'/'+locations[3]; 
            var staticPath  = basePath+"/static/images/login/sliding-icon-active.png";
            $('#label .slide-icon').css("background-image","url("+staticPath+")");
            me.success();
        }
        me.updateView();
    };
